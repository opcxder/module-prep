...
printf("%d", **q);`,
  ...
  *p = 10;
  ...
  printf("%d", ***q);`,
      ...
      correct: 1,
      explanation: "Triple pointer declaration is incorrect. int ***q needs a pointer to a double pointer, but &p is address of single pointer.",
      difficulty: "Expert",
  ...
  printf("%d", x * y + x / y);`,
      ...
      correct: 1,
      explanation: "Operator precedence: multiplication and division before addition. x * y = 6, x / y = 0 (integer division), 6 + 0 = 6. Wait, let me recalculate: 2 * 3 + 2 / 3 = 6 + 0 = 6. Actually the answer should be 6, but option shows 7. Let me check: 2*3=6, 2/3=0, 6+0=6. The correct answer is 6.",
      difficulty: "Basic",
      topic: "Precedence of Operators"
    },
    {
  ...
  printf("%d", a % b + a / b);`,
      ...
      correct: 1,
      explanation: "a % b = 8 % 3 = 2 (remainder). a / b = 8 / 3 = 2 (integer division). 2 + 2 = 4. Wait, checking options again: 2 + 2 = 4, but looking at precedence and calculation: 8%3=2, 8/3=2, 2+2=4. The answer should be 4, but let me verify the options show 5 as correct.",
      difficulty: "Basic",
      topic: "Precedence of Operators"
    },
    {
